...
module.exports = {
  ...
  operation: {
    ...
    fields: [{
      ...
      placeholder: '状态',
      type: 'select',
      options: [{ key: '待出库', value: 'WaitForStorageOut' }, { key: '部分出库', value: 'SectionStorageOut' }, { key: '全部出库', value: 'TotalStorageOut' }, { key: '草稿', value: 'Draft' }, { key: '待审核', value: 'Wait_To_Audit' }, { key: '关闭', value: 'Closed' }]
    }]
  },
  search: {},
  table: {
    ...
    { title: '订单总费用', field: 'salesTotal', align: 'right', valueType: 'currency' }, { title: '订单总数量', field: 'totalCount', align: 'right' }, { title: '创建时间', field: 'transactionTime' }, { title: '状态', field: 'salesStatus', valueType: 'statusTag' }],
    operation: [{
  ...
  form: {
    fields: [{
      ...
      rules: [{ required: true }]
    }, { field: 'salesTime', type: 'datetime', intlPrefix: 'sales.' }, { field: 'transactionBy', type: 'input', intlPrefix: 'sales.' }, { field: 'originatorName', type: 'get-account', intlPrefix: 'sales.' }, { field: 'salesNote', type: 'input', intlPrefix: 'sales.' },
  ...
  children: {
    ...
    table: {
      ...
      columns: [{ title: '商品条码', field: 'skuBarcode' }, { title: '时间', field: 'transactionTime' }, { title: '商品编号', field: 'skuCode' }, { title: '商品名称', field: 'skuName' }, {
        title: '销售数量', field: 'transactionQuantities', mark: 'd->t', valueType: 'editQuantity', // transactionQuantities
        value: 1,
        options: {
          minValue: 1
        }
      }, { title: '单价', field: 'transactionSkuPrice', valueType: 'editCurrency' }, { title: '总价', field: 'transactionTotalSkuPrice', valueType: 'totalPrice' }, { title: '单位', field: 'skuUnit' }],
      footer: {
        type: 'showPrice',
        totalPriceText: '商品总额',
  ...
  details: {
    ...
    table: {
      columns: [{ title: '分销订单编号', field: 'salesCode' }, { title: '分销商', field: 'traderName' }, { title: '总价', field: 'salesTotal', align: 'right', valueType: 'currency' }, { title: '时间', field: 'salesTime' }, { title: '备注', field: 'salesNote' }, { title: '制单人', field: 'originatorName' }, { title: '状态', field: 'salesStatus', valueType: 'statusTag' }]
    },
    form: {
      fields: [
      ...
      // { field: 'traderName', type: 'plain', intlPrefix: 'sales.' },
      {
        ...
        field: 'transactionTime', type: 'datetime', intlPrefix: 'sales.',
        rules: [{ required: true }]
      }, { field: 'transactionBy', type: 'input', intlPrefix: 'sales.' }, { field: 'note', type: 'input', intlPrefix: 'sales.' }, { field: 'originatorName', type: 'get-account', intlPrefix: 'storagesOut.' }, {
        field: 'outItems', type: 'children', intlPrefix: 'sales.',
        API: '/api/wms/skus',
        mapItemFieldTo: 'outItems',
        fieldMap: [{ from: 'id', to: 'skuId' }, { from: 'skuPrice', to: 'transactionSkuPrice', value: 0 }, { from: '', to: 'transactionQuantities', value: 1 }, { from: 'createTime', to: 'transactionTime' }, { from: 'barCode', to: 'skuBarcode' }, { from: 'field1', to: 'skuUnit' }],
    ...
    children: {
      table: {
        ...
        columns: [{ title: '商品编号', field: 'skuCode' }, { title: '商品条码', field: 'skuBarcode' }, { title: '商品名称', field: 'skuName' }, { title: '单位', field: 'skuUnit' }, { title: '总数', field: 'totalCount' }, { title: '已出库数', field: 'finishedCount' }, {
