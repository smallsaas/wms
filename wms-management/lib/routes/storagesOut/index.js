...
var Index = (_dec = (0, _dva.connect)(function (_ref) {
  var storagesOut = _ref.storagesOut,
  ...
  (0, _createClass3.default)(Index, [{
    ...
    value: function render() {
      var submitButton = this.props.location.search.indexOf('edit') > -1 ? [{ title: '提交审核', method: 'put', API: '/api/wms/storages/out/[id]/audit' }, { title: '保存修改', method: 'put', API: '/api/wms/storages/out/[id]' }, { title: '取消', type: 'return' }] : [];
      return _react2.default.createElement(_kqdGeneral.GMApp, (0, _extends3.default)({}, this.props, { config: _config2.default,
        ...
        routerMap: {
          query: _react2.default.createElement(_query2.default, { queryConfig: {
              ...
              columns: [{ title: ' ', field: 'total' }, { title: '商品条码', field: 'skuBarcode' }, { title: '商品编号', field: 'skuCode' }, { title: '商品名称', field: 'skuName' }, { title: '需求数量', field: 'demandQuantities', align: 'right', bottomTotal: true }, { title: '出库数量', field: 'transactionQuantities', align: 'right', bottomTotal: true }, { title: '商品价格', field: 'transactionSkuPrice', align: 'right', valueType: 'currency' }, { title: '单位', field: 'skuUnit' }]
            },
            logType: 'out'
          }),
