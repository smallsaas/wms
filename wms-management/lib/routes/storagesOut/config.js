...
module.exports = {
  ...
  operation: {
    ...
    fields: [{
      ...
      placeholder: '出库类型',
      type: 'select',
      options: [{ key: '销售出货', value: 'SalesOut' }, { key: '分销商出库', value: 'CustomerStorageOut' }, { key: '采购退货', value: 'Refund' }, { key: '调拨出库', value: 'TransferOut' }, { key: '其它出库', value: 'OthersStorageOut' }]
    }]
  },
  search: {},
  table: {
    ...
    }, { title: '出库时间', field: 'transactionTime', sorter: function sorter(a, b) {
    ...
    { title: '仓库名称', field: 'warehouseName' }, { title: '订单号信息', field: 'outOrderNum' }, { title: '客户', field: 'distributorCustomer' }, { title: '状态', field: 'status', valueType: 'statusTag' },
    // { title: '备注', field: 'note' },
  ...
  form: {
    ...
    //   ]
    // },
    { field: 'transactionBy', type: 'input', intlPrefix: 'storagesOut.' }, { field: 'outOrderNum', type: 'input', intlPrefix: 'storagesOut.' }, { field: 'distributorCustomer', type: 'input', intlPrefix: 'storagesOut.' }, { field: 'transactionTime', type: 'datetime', intlPrefix: 'storagesOut.' }, { field: 'originatorName', type: 'get-account', intlPrefix: 'storagesOut.' }, { field: 'note', type: 'input', intlPrefix: 'storagesOut.', span: 2 }, {
  ...
  children: {
    ...
    table: {
      ...
      columns: [{ title: '商品条码', field: 'skuBarcode' }, { title: '出库时间', field: 'transactionTime' }, { title: '商品编号', field: 'skuCode' }, { title: '商品名称', field: 'skuName' }, {
        title: '出库数量', field: 'transactionQuantities', mark: 'd->t', valueType: 'editQuantity',
        options: {
          minValue: 1
        }
      }, { title: '出库价格', field: 'transactionSkuPrice', valueType: 'editQuantity' }, { title: '单位', field: 'skuUnit' }]
    }
  }
};