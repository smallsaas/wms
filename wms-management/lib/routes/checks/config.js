...
module.exports = {
  ...
  operation: {
    ...
    fields: [{
      ...
      placeholder: '状态',
      type: 'select',
      options: [{ key: '待盘点', value: 'WaitForCheck' }, { key: '盘点中', value: 'Checking' }, { key: '盘点结束', value: 'CheckOut' }, { key: '草稿', value: 'Draft' }, { key: '待审核', value: 'Wait_To_Audit' }, { key: '完成', value: 'Done' }, { key: '关闭', value: 'Closed' }]
    }]
  },
  search: {},
  table: {
    ...
    }, { title: '盘点仓库', field: 'warehouseName' }, { title: '经办人', field: 'transactionBy' }, { title: '备注', field: 'checkNote' }, { title: '盘点时间', field: 'checkTime' },
    // { title: '完成时间', field: 'checkTime'},
    { title: '状态', field: 'status', valueType: 'statusTag' }, { title: '制单人', field: 'originatorName' }],
    operation: [{
  ...
  form: {
    ...
    // { field: 'profitLost', type: 'number', intlPrefix: 'checks.' },
    {
      ...
      rules: [{ required: true }]
    }, { field: 'transactionBy', type: 'input', intlPrefix: 'checks.' }, { field: 'checkNote', type: 'input', intlPrefix: 'checks.' }, { field: 'checkTime', type: 'datetime', intlPrefix: 'checks.' }, { field: 'originatorName', type: 'get-account', intlPrefix: 'checks.' }, {
      field: 'skuRecords', type: 'children', intlPrefix: 'checks.',
      API: '/api/wms/inventories',
      mapItemFieldTo: 'checkSkus',
      fieldMap: [{ from: 'validSku', to: 'deservedQuantities', mark: 'd->t|t->d', value: 0 }],
      columns: [{ title: '商品条码', field: 'skuBarcode' }, { title: '商品编号', field: 'skuCode' }, { title: '商品名称', field: 'skuName' }, { title: '数量', field: 'validSku' }, { title: '单位', field: 'skuUnit' }],
      operation: {
        fields: [{
          field: 'search',
          placeholder: '商品名称/条码',
  ...
  children: {
    ...
    table: {
      ...
      columns: [{ title: ' ', field: 'total' }, { title: '商品编号', field: 'skuCode' }, { title: '商品条码', field: 'skuBarcode' }, { title: '商品名称', field: 'skuName' }, {
  ...
  details: {
    table: {},
    form: {
      fields: [{ field: 'checkCode', type: 'plain', intlPrefix: 'checks.' }, { field: 'warehouseName', type: 'plain', intlPrefix: 'checks.' }, { field: 'checkTime', type: 'plain', intlPrefix: 'checks.' }, { field: 'originatorName', type: 'plain', intlPrefix: 'checks.' }, { field: 'checkNote', type: 'plain', intlPrefix: 'checks.', span: 2 }, {
    ...
    children: {
      table: {
        ...
        columns: [{ title: ' ', field: 'total' }, { title: '商品编号', field: 'skuCode' }, { title: '商品条码', field: 'skuBarcode' }, { title: '商品名称', field: 'skuName' }, { title: '单位', field: 'skuUnit' }, {
