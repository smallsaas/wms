...
exports.default = {
  ...
  operation: {
    ...
    fields: [{
      ...
      placeholder: '入库类型',
      options: [{ key: '销售退货', value: 'SalesIn' }, { key: '调拨入库', value: 'TransferIn' }, { key: '采购入库', value: 'Procurement' }, { key: '分销商退货', value: 'CustomerStorageIn' }, { key: '其它入库', value: 'OthersStorageIn' }]
    }]
  },
  search: {},
  table: {
    ...
    }, { title: '入库时间', field: 'transactionTime', sorter: function sorter(a, b) {
  ...
  form: {
    ...
    // field-config-select
    {
      ...
      { key: '分销商退货', value: 'CustomerStorageIn' }, { key: '其它入库', value: 'OthersStorageIn' }],
      rules: [{ required: true }]
    },
    ...
    { field: 'transactionBy', type: 'input', intlPrefix: 'storagesIn.' }, { field: 'transactionTime', type: 'datetime', intlPrefix: 'storagesIn.' }, { field: 'originatorName', type: 'get-account', intlPrefix: 'storagesIn.' }, { field: 'note', type: 'input', intlPrefix: 'storagesIn.', span: 2 }, {
      field: 'storageInItems', type: 'children', intlPrefix: 'storagesIn.',
      API: '/api/wms/skus',
      mapItemFieldTo: 'storageInItems',
      fieldMap: [{ from: 'id', to: 'skuId' }, { from: 'skuPrice', to: 'transactionSkuPrice' }, { from: '', to: 'transactionQuantities', value: 1 }, { from: 'createTime', to: 'transactionTime', value: (0, _moment2.default)().format('YYYY-MM-DD HH:mm:ss') }, { from: 'barCode', to: 'skuBarcode' }, { from: 'field1', to: 'skuUnit' }],
  ...
  children: {
    ...
    table: {
      ...
      columns: [{ title: '商品条码', field: 'skuBarcode' }, { title: '入库时间', field: 'transactionTime' }, { title: '商品编号', field: 'skuCode' }, { title: '商品名称', field: 'skuName' }, {
  ...
  details: {
    operation: {
      action: [{ title: '打印', action: 'add', options: { path: '/TODO' } }]
    },
    search: {},
    form: {
      fields: [{ field: 'warehouseName', type: 'plain', intlPrefix: 'storagesIn.' }, { field: 'transactionCode', type: 'plain', intlPrefix: 'storagesIn.' }, { field: 'transactionTime', type: 'plain', intlPrefix: 'storagesIn.' }, { field: 'originatorName', type: 'plain', intlPrefix: 'storagesIn.' }],
      colNumber: 4
    },
    table: {
      API: '/api/wms/storages/in',
      dataField: 'currentItem.storageInItemRecords',
      columns: [{ title: '商品条码', field: 'skuBarcode' }, { title: '商品名称', field: 'skuName' }, { title: '单位', field: 'skuUnit' }, { title: '数量', field: 'transactionQuantities' }, { title: '单价', field: 'transactionSkuPrice', align: 'right', valueType: 'currency' }, { title: '入库类型', field: 'transactionType', valueType: 'statusTag' }]
    }
  }
};