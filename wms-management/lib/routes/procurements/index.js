...
var Index = (_dec = (0, _dva.connect)(function (_ref) {
  var procurements = _ref.procurements,
  ...
  (0, _createClass3.default)(Index, [{
    ...
    value: function render() {
      var formProps = this.props.location.search.indexOf('edit') > -1 ? {
        submitButton: [{ title: '提交审核', method: 'put', API: '/api/wms/procurements/[id]/audit' }, { title: '保存修改', method: 'put', API: '/api/wms/procurements/[id]' }, { title: '取消', type: 'return' }]
      } : undefined;
