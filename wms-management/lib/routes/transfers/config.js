...
module.exports = {
  ...
  search: {
    fields: [{
      ...
      label: '状态',
      type: 'select',
      options: [{ key: '调拨中', value: 'Transfer' }, { key: '草稿', value: 'Draft' }, { key: '待审核', value: 'Wait_To_Audit' }, { key: '审核通过', value: 'Audit_Passed' }, { key: '完成', value: 'Done' }, { key: '关闭', value: 'Closed' }]
    }, {
  ...
  table: {
    ...
    }, { title: '调出仓库', field: 'fromWarehouseName' }, { title: '调入仓库', field: 'toWarehouseName' }, { title: '调出时间', field: 'transactionTime' }, { title: '调入时间', field: 'finishTime' }, { title: '状态', field: 'status', valueType: 'statusTag' }, { title: '经办人', field: 'transactionBy' }],
    operation: [
  ...
  form: {
    ...
    //     ]
    // },
    { field: 'transactionBy', type: 'input', intlPrefix: 'transfers.' }, { field: 'originatorName', type: 'get-account', intlPrefix: 'transfers.' }, { field: 'note', type: 'input', intlPrefix: 'transfers.', span: 2 }, {
      field: 'outItems', type: 'children', intlPrefix: 'storagesIn.',
      API: '/api/wms/skus',
      mapItemFieldTo: 'outItems',
      fieldMap: [{ from: 'id', to: 'skuId' }, { from: 'skuPrice', to: 'transactionSkuPrice' }, { from: '', to: 'transactionQuantities', value: 0 }, { from: 'createTime', to: 'transactionTime' }, { from: 'barCode', to: 'skuBarcode' }, { from: 'field1', to: 'skuUnit' }],
  ...
  children: {
    ...
    table: {
      ...
      columns: [{ title: '商品条码', field: 'skuBarcode' },
      // { title: '入库时间', field: 'transactionTime' },
      { title: '商品编号', field: 'skuCode' }, { title: '商品名称', field: 'skuName' }, { title: '库存余量', field: 'validSku' }, {
  ...
  details: {
    ...
    table: {
      columns: [{ title: '商品编码', field: 'id' }, { title: '商品条码', field: 'skuBarcode' }, { title: '商品名称', field: 'skuName' }, { title: '商品规格', field: 'tode' }, { title: '单位', field: 'skuUnit' }, { title: '调拨数量', field: 'transactionQuantities' }]
    },
    form: {
      fields: []
    }
