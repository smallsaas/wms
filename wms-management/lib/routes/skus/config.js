...
exports.default = {
  ...
  table: {
    ...
    { title: '条形码', field: 'barCode' }, { title: '单位', field: 'field1' },
  ...
  form: {
    fields: [{ field: '基本信息', label: '', type: 'group', span: 2 }, {
    ...
    { field: 'spec', type: 'input', intlPrefix: 'skus.' }, { field: 'volume', type: 'input', intlPrefix: 'skus.' }, { field: 'weight', type: 'input', intlPrefix: 'skus.' }],
    colNumber: 2
  },
  details: {
    form: {
      ...
      }, { field: 'spec', type: 'plain', intlPrefix: 'skus.' }, { field: 'volume', type: 'plain', intlPrefix: 'skus.' }, { field: 'weight', type: 'plain', intlPrefix: 'skus.' }],
      colNumber: 2
    }
  }
};