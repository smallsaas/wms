...
public class Equipment extends Model<Equipment> {
    ...
    /**
     * 设备流水号的数字形式，当批量生成的时候，需找出表中最大的number_of_code，从number_of_code+1开始生成
     */
	@TableField("number_of_code")
	private Integer numberOfCode;
    /**
     * 批次,用于指定该设备是由第几次批量生成来创建的，方便按批更新
     */
	@TableField("batch_number")
	private Integer batchNumber;
    /**
     * 设备编码，格式：IT M I 00021（IT 电子设备类别 M 手机类别 I 苹果类别 00021 设备流水号）
     */
	private String code;
    /**
     * 设备名称
    ...
    /**
     * 类别名称，显示类别名称的时候不需要去category表查询，无论category相应的类别怎么变化，是删除还是改名，这里显示的都是生成设备时的类别名
     */
	...
	public Integer getNumberOfCode() {
		return numberOfCode;
	}

	public void setNumberOfCode(Integer numberOfCode) {
	...
	public static final String NUMBER_OF_CODE = "number_of_code";
