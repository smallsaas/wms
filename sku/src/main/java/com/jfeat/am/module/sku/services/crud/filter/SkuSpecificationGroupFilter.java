 ...
 */
public class SkuSpecificationGroupFilter implements CRUDFilter<SkuSpecificationGroup> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(SkuSpecificationGroup entity, boolean insertOrUpdate) {
